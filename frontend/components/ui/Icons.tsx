...
export const MovementsIcon: React.FC<IconProps> = ({
  size = 20,
  className = '',
  ...props
}) => (
...
export const UnitsIcon: React.FC<IconProps> = ({
  size = 20,
  className = '',
  ...props
}) => (
...
export const AllocationsIcon: React.FC<IconProps> = ({
  size = 20,
  className = '',
  ...props
}) => (
...
export const BranchTransfersIcon: React.FC<IconProps> = ({
  size = 20,
  className = '',
  ...props
}) => (
